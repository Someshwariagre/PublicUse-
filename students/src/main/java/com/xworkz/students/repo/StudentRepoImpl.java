...
public class StudentRepoImpl implements StudentRepo {
	...
	public List<StudentDto> readAll() {
		em.getTransaction().begin();
		Query query = em.createNamedQuery("readAll", StudentDto.class);
...
//
//			em.getTransaction().begin();
//			Query query = em.createNamedQuery("findByColourAndWieght", StudentDto.class);
...
//
//			em.getTransaction().begin();
//			Query query = em.createNamedQuery("findByPriceAndName", StudentDto.class);
