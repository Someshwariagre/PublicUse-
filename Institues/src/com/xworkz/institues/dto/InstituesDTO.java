package com.xworkz.institues.dto;

public class InstituesDTO {
	private String name;
	...
	public InstituesDTO(String name, String location, int noOfTrainers, int noOfStudents, String course, int rating) {
		super();
		this.name = name;
		this.location = location;
		this.noOfTrainers = noOfTrainers;
